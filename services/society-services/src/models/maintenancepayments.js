...
MaintenancePaymentsModel.syncIndexes().then(() => {
    console.log('Maintenance Payments Model Indexes Synced')
}).catch((err) => {
    console.log('Maintenance Payments Model Indexes Sync Error', err)
})

module.exports = MaintenancePaymentsModel